...
mysql_conn = MySQLdb.connect(
    host='10.161.235.42',
    user='ets1szh',
    passwd='estbangbangde',
    db='zeekr'
)
mysql_cursor = mysql_conn.cursor()

# Retrieve data from SQLite
sqlite_cursor.execute('SELECT soc_version, cus_version, tester, bench_id, test_type, start_time, end_time, error_keyword, result FROM stability')
