        ...
        if dCategory:
            try:
                ...
                oExecutionType = oTree.find(
                    f'{{{self.NAMESPACES["ns2"]}}}category[@term="Execution Type"]',
                    nsmap,
                )
    ...
    def createTestscriptTemplate(self, testscriptName, sOwnerID="", scripts=None):
        ...
        if scripts:
            ...
            for step in scripts:
                ...
                ostep = etree.Element(
                    "{http://jazz.net/xmlns/alm/qm/v0.1/testscript/v0.1/}step",
                    nsmap=nsmap,
                )
                ostepDescription = etree.Element(
                    "{http://jazz.net/xmlns/alm/qm/v0.1/testscript/v0.1/}description",
                    nsmap=nsmap,
                )
                ...
                ostepExpectedResult = etree.Element(
                    "{http://jazz.net/xmlns/alm/qm/v0.1/testscript/v0.1/}expectedResult",
                    nsmap=nsmap,
                )
